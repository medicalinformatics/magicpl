...
public class AdapterFactory {
    ...
    public static Adapter getAdapter(Iosingle config) throws ClassNotFoundException, IllegalAccessException,
    ...
    public static Adapter getAdapter(Iorecord config) throws ClassNotFoundException, IllegalAccessException,
    ...
    public static Adapter getAdapter(Ioabstracttype config) throws ClassNotFoundException, IllegalAccessException,
            InstantiationException, NoSuchMethodException, InvocationTargetException {
    ...
    public static <T> Adapter<T> getAdapter(Class<T> clazz) throws ClassNotFoundException, InstantiationException,
